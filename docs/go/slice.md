...
> Ele permite manipular grandes conjuntos de dados de forma eficiente, sem necessidade de copiar memória.  
...
Em vez de copiar cada lote para um novo array, basta criar um slice apontando para a região desejada.
...
O runtime verifica se ainda existe capacidade disponível no array subjacente.
...
Por isso é uma boa prática sempre capturar o retorno de `append()`.
